...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const presetIds = new Set(presetsList().map((p) => p.id));
  let presetId = 'avg_fc_per_board';
  if (presetParam === 'avg_false_calls_per_assembly') {
    presetId = 'avg_fc_per_board';
  } else if (presetParam && presetIds.has(presetParam)) {
